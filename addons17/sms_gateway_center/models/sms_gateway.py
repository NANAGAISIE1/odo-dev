                        ...
                        if acc.gateway_name == 'twilio':
                            ...
                            try:
                                ...
                                if tw_cust.mobile is boolean:
                                    raise UserError("Mobile Number is Not Available")
                                else:
                                    raise UserError("To number: "+tw_cust.mobile+" is incorrect mobile number")
                        else:
                                ...
                                if acc.gateway_name == 'twilio':
                                    ...
                                    try:
                                        ...
                                        if single.mobile is boolean:
                                            ...
                                            raise UserError("To number: "+single.mobile+" is incorrect mobile number")
                                else:
                                    if self.multi_customer:
                                        for cust in self.multi_customer:
                                            if cust.mobile:
    ...
    def create(self, vals):
        if vals['gateway_name'] == 'msg_91':
            if vals['sender_id_msg91'] == False:
                ...
                raise ValidationError('Sender Id must be 6 character long is required')
        else:
            if vals['gateway_name'] == 'twilio' and vals['sid'] == False:
                ...
                raise ValidationError('From Number is Required')
